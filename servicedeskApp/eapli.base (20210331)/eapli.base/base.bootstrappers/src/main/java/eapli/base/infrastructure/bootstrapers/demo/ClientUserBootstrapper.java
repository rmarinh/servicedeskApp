...
import eapli.base.colaboradormanagement.application.AcceptRefuseSignupFactory;
import eapli.base.colaboradormanagement.application.AcceptRefuseSignupRequestController;
...
public class ClientUserBootstrapper implements Action {
    ...
    public boolean execute() {
        signupAndApprove(TestDataConstants.USER_TEST1, "Password1", "John", "Smith",
                "lapr4_2+2@protonmail.com", TestDataConstants.USER_TEST1);
        signupAndApprove("isep959", "Password1", "Mary", "Smith", "lapr4_2+3@protonmail.com", "isep959");
        return true;
    }
